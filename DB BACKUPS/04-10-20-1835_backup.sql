...
--
-- Table structure for table `art_poem`
--

DROP TABLE IF EXISTS `art_poem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `art_poem` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_3dd1fa42b079bf883bfd7122a8d` (`userId`),
  CONSTRAINT `FK_3dd1fa42b079bf883bfd7122a8d` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `collection` (
  ...
  `userId` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_ca25eb01f75a85272300f336029` (`userId`),
  CONSTRAINT `FK_ca25eb01f75a85272300f336029` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `comment` (
  ...
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `artpoemId` int(11) DEFAULT NULL,
  `userId` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_39b8b4c9c1ee477473b0148da88` (`artpoemId`),
  KEY `FK_c0354a9a009d3bb45a08655ce3b` (`userId`),
  CONSTRAINT `FK_39b8b4c9c1ee477473b0148da88` FOREIGN KEY (`artpoemId`) REFERENCES `art_poem` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
CREATE TABLE `like` (
  ...
  `artpoemId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `IDX_4b432f0b2c1c0c723bb6cbab42` (`artpoemId`,`userId`),
  KEY `FK_e8fb739f08d47955a39850fac23` (`userId`),
  CONSTRAINT `FK_4b2502ffac33456919b66cd446a` FOREIGN KEY (`artpoemId`) REFERENCES `art_poem` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FK_e8fb739f08d47955a39850fac23` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2020-10-04 18:35:44
